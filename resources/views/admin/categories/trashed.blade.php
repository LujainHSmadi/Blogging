    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1><i class="mdi mdi-delete"></i> Categories </h1>
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.categories-index') }}">
                                    <i class="mdi  mdi-home"></i> Categories
                                </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page"><i class="mdi mdi-delete"></i>  Categories Archive
                            </li>
                        </ol>
                    </nav>
                </div>
                            ...
                            @if (isset($categories) && $categories->count() > 0)
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td style="text-align: center">{!! isset($category->status) ? $category->status : "<span style='color:blue;'>----------</span>" !!} </td>
